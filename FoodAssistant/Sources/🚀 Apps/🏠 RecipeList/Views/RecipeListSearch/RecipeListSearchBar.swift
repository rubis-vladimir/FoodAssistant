...
class RecipesSearchBar: UISearchBar {
    ...
    private lazy var filterButton: UIButton = {
        ...
        button.layer.add(shadow: Shadow.one)
    ...
    private func setViews() {
        ...
        textField.layer.add(shadow: Shadow.one)

        textField.backgroundColor = .white
        textField.inputView?.layer.add(shadow: Shadow.one)
...
extension RecipesSearchBar {
    /// Тень
    private enum Shadow: ShadowProtocol {
        case one
